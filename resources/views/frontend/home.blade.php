              ...
              "spaceBetween": 120
                ...
                <div class="swiper-wrapper align-items-center">
                    ...
                    <div class="swiper-slide"><img src="{{ asset('assets_two/img/clients/kerja3.jpg') }}" class="img-fluid"
                            alt=""></div>
                    <div class="swiper-slide"><img src="{{ asset('assets_two/img/clients/kerja4.jpeg') }}"
                    ...
                    @foreach ($portfolios as $portfolio)
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                            ...
                            <div class="portfolio-info">
                                ...
                                <a href="{{ asset('storage/' . $portfolio->foto) }}" title="App 1"
          ...
          color: #f39c12;
                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="info">
                        ...
                        <p>We appreciate your thoughts on our services and products. Your feedback helps us improve and
                            serve you better. Please let us know about your experience.</p>
